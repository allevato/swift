...
// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk-nosource -I %t) -parse-as-library -I %S/Inputs/custom-modules %t/override.swiftmodule -typecheck -emit-objc-header-path %t/override.h
