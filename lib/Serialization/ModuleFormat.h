...
const uint16_t SWIFTMODULE_VERSION_MINOR = 524; // direct module deps in debugging options
...
namespace input_block {
  ...
  using DirectlyRequestedModuleLayout = BCRecordLayout<
    DIRECTLY_REQUESTED_MODULE,
    BCBlob // file path
  >;
